...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Jika tidak ada error, simpan data (dalam contoh ini kita hanya simpan di session)
    if (empty($name_err) && empty($email_err) && empty($phone_err) && empty($password_err) && empty($confirm_password_err)) {
        // Simpan data user (dalam aplikasi nyata, simpan ke database)
    ...
    <div class="position-relative z-10 w-100" style="max-width: 32rem;">
        ...
        <div class="glass-effect p-4">
            ...
            <p class="mt-4 text-center text-muted small">
                Sudah punya akun? 
                <a href="login.php" class="text-decoration-none text-indigo fw-medium">Masuk di sini</a>
            </p>
        </div>
    </div>
